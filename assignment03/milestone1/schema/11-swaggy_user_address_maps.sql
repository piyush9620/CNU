...
DROP TABLE IF EXISTS `user_address_maps`;
...
CREATE TABLE `user_address_maps` (
  ...
  CONSTRAINT `user_address_address_id_fk` FOREIGN KEY (`address_id`) REFERENCES `address` (`id`),
  CONSTRAINT `user_address_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
